var Draw = (function () {
    ...
    var drawARegularTile = function (color, width) {
    ...
    var drawStartField = function (color, width, text) {
        var imgData = ctx.createImageData(width, width);
        var pos = 0;
        setColor(color);
        for (var x = 0; x < width; x++) {
    ...
    var drawCenterTile = function (width) {
        var imgData = ctx.createImageData(width, width);
        var pos = 0;
        for (var x = 0; x < width; x++) {
            for (var y = 0; y < width; y++) {
    ...
    return {
        setColor: setColor,
        drawCenterTile: drawCenterTile,
        drawStartField: drawStartField,
        drawARegularTile: drawARegularTile,
        refreshBoard: refreshBoard,
        drawTheBoard: drawTheBoard,
        createMyMap: createMyMap,
